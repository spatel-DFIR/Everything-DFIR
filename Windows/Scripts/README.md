...
prior ad hoc one-off into an evidence-weighted triage tool, sharing one doctrine: **flag on evidence, enumerate
...
- **Author:** Suvas Patel · **current version:** all four tools are v1.0 or later.
